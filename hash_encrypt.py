...
def hash_encrypt(user_id, password):
    ...
    salt_a_a = load_data['config']['login']['password']['salt']['salt_a_a']
    salt_a_b = load_data['config']['login']['password']['salt']['salt_a_b']
    salt_b_a = load_data['config']['login']['password']['salt']['salt_b_a']
    salt_b_b = load_data['config']['login']['password']['salt']['salt_b_b']
    pwd = password
